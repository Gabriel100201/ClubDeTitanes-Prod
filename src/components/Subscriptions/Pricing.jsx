      ...
      <section className="text-gray-200 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap -m-4">
            <div className="p-4 xl:w-1/2 md:w-1/2 w-full backdrop-blur-sm">
              <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                ...
                <p className="text-xs text-gray-200 mt-3">Literally you probably havent heard of them jean shorts.</p>
              </div>
            </div>
            <div className="p-4 xl:w-1/2 md:w-1/2 w-full backdrop-blur-sm">
              <div className="h-full p-6 rounded-lg border-2 border-primary-500 flex flex-col relative overflow-hidden">
                ...
                <button onClick={generateUrl} className="flex relative items-center mt-auto text-white bg-primary-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-primary-600 rounded">
                  <span>
                    Subscríbete
                  </span>
                  {!isPaymentLoading &&
