...
export const SectionProximamente = () => {
  ...
  return (
    <section className="bg-alternative-950 relative h-[calc(100vh-90px)] -mt-3 w-full flex justify-center items-center p-0 sm:p-8 py-32 lg:py-48">
      ...
      <div className="bg-gradient-to-b py-3 z-10 espacio-titanes from-primary-200 via-primary-400 to-primary-600 inline-block text-center text-transparent bg-clip-text text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold">
        ¡PRÓXIMAMENTE!
      </div>
    </section>
  );
