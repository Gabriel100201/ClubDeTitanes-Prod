    ...
    <div className="w-full bg-gradient-to-br from-secondary-950 via-secondary-950 to-secondary-800">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
          <a href="#" className="inline-flex items-center justify-center px-4 py-2.5 text-base font-medium text-center text-white bg-gradient-to-br from-primary-700 to-primary-500 rounded-lg hover:from:to-proimary-500 hover:to-primary-400 focus:ring-4 focus:ring-primary-300">
            Empezá hoy
          </a>
