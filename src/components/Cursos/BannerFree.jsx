  ...
  return (
    <div className="w-full bg-gradient-to-br from-secondary-950 via-secondary-950 to-secondary-800 shadow_section">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <h2 className="mb-4 text-5xl tracking-tight font-extrabold text-white">La plataforma donde aprenderás todo acerca de negocios, mentalidad y expansión empresarial</h2>
        <p className="mb-8 font-light sm:text-xl text-gray-400">Accede a nuestro exclusivo contenido diseñado para transformar tu mentalidad y expandir tu negocio. Conviértete en un líder empresarial invirtiendo en tu crecimiento hoy mismo.</p>
