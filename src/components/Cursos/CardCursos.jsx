    ...
    return (
        <div className="lg:flex border border-secondary-700 bg-gray-800/20 rounded-lg shadow bgCursoCard">
            ...
            <div className="flex flex-col justify-between py-6 lg:mx-6">
                ...
                <button onClick={handleCursoClick} target='_blank' className="px-6 py-2 flex items-center cursor-pointer justify-center gap-2 font-medium text-center tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                    <span>
                        Ver Curso
                    </span>
                    {!url && <FaLock />}
