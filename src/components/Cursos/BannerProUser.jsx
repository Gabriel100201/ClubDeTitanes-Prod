export const BannerProUser = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-br relative from-secondary-950 via-secondary-950 to-secondary-800">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 text-center">
        ...
        <h2 className="mb-4 tracking-tight font-extrabold text-gray-900 dark:text-white text-5xl">Explora nuevos cursos y sigue ampliando tus conocimientos</h2>
      ...
      <div className="absolute arrow bottom-[-12.5px] rotate-45 opacity-25 bg-gradient-to-r from-primary-700 to-primary-500 w-[25px] h-[25px]" />
    </div>
  )
}