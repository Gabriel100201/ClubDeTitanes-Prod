  ...
  return (
    <div className="w-full bg-gradient-to-br relative from-secondary-950 via-secondary-950 to-secondary-800 shadow_section">
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 text-center">
        ...
        <h2 className="mb-4 tracking-tight font-extrabold text-white text-2xl md:text-5xl">Explora nuevos cursos y sigue ampliando tus conocimientos</h2>
        <p className="mb-8 font-light sm:text-2xl text-gray-400">Aprovecha al máximo tu suscripción accediendo a contenido exclusivo diseñado para llevar tu negocio al siguiente nivel. ¡Tu viaje hacia el éxito continúa aquí!</p>
      </div>
